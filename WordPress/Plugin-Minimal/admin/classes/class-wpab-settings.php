...
class WPAB_Settings {
    ...
    public function sanitize( $input ) {
        ...
        $new_input['approval_email_address'] = isset( $input['approval_email_address'] ) ? sanitize_email( $input['approval_email_address'] ) : '';
        $new_input['send_calendar_alerts'] = isset( $input['send_calendar_alerts'] ) ? 1 : 0;
        $new_input['alert_email_address'] = isset( $input['alert_email_address'] ) ? sanitize_email( $input['alert_email_address'] ) : '';
    ...
    private function add_settings_fields() {
        ...
        add_settings_field(
            'mailgun_api_key',
            'Mailgun API Key',
            array( $this, 'mailgun_api_key_callback' ),
            'wpab',
            'wpab_api_settings'
        );
        add_settings_field(
            'mailgun_domain',
            'Mailgun Domain',
            array( $this, 'mailgun_domain_callback' ),
            'wpab',
            'wpab_api_settings'
        );
        ...
        add_settings_field(
            ...
            array( 'WPAB_Settings_Fields', 'approval_email_address_callback' ),
            'wpab',
            'wpab_general_settings'
        );
        add_settings_field(
        ...
        add_settings_field(
            'alert_email_address',
            'Alert Email Address',
            array( 'WPAB_Settings_Fields', 'alert_email_address_callback' ),
            'wpab',
            'wpab_general_settings'
        );
        add_settings_field(
